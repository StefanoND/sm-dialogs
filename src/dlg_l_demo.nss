...
void PoetDialog_Init()
{
    ...
    AddDialogPage(POET_PAGE_INFO,
                  "I am demonstrating continued pages. Continued pages are used when " +
                      "you want to have several pages of text with a continue button in " + "between.");
    AddDialogPage(POET_PAGE_INFO,
    ...
    AddDialogPage(POET_PAGE_POOR, "Oh, I'm sorry. It seems you don't have enough coin on you. I don't " +
                                      "recite poetry for free, you know.");
    AddDialogNode(POET_PAGE_POOR, POET_PAGE_INFO, "Can you tell me who you are instead?");
    EnableDialogEnd("Goodbye", POET_PAGE_POOR);

    // PC chose poem "Mary Had A Little Lamb"
    AddDialogPage(POET_PAGE_MARY, "Mary had a little lamb,\n" + "Little lamb,\nLittle lamb.\n" +
                                      "Mary had a little lamb.\n" + "Its fleece was white as snow.");
    sPage =
        AddDialogPage(POET_PAGE_MARY, "Everywhere that Mary went,\n" + "Mary went,\nMary went,\n" +
    ...
    sPage = AddDialogPage(
        POET_PAGE_MARY, "It made the children laugh and play,\n" + "Laugh and play,\nLaugh and play,\n" +
    ...
    AddDialogPage(POET_PAGE_SICK, "I cannot go to school today,\n" + "Said little Peggy Ann McKay.\n" +
    ...
    sPage = AddDialogPage(
        POET_PAGE_SICK, "My back is wrenched, my ankle's sprained,\n" +
    ...
    sPage = AddDialogPage(POET_PAGE_SICK, "I have a hangnail, and my heart is--what?\n" +
...
void TokenDialog()
{
    ...
    AddDialogPage(TOKEN_PAGE_MAIN, "Hello, <FirstName>. Isn't this a fine <quarterday>?");
    ...
    AddDialogPage(TOKEN_PAGE_INFO, "There are lots of tokens available, such as <<class>>, " +
                                       "<<race>>, and <<level>>.\n\n" +
    ...
    AddDialogPage(TOKEN_PAGE_INFO,
                  "Some tokens cannot be converted to lowercase; if there are any " +
                      ...
                      "<<FullName>> -> <FullName>\n" + "<<fullname>> -> <fullname>");
    string sPage = AddDialogPage(
        TOKEN_PAGE_INFO, "Tokens are specific to a dialog, so if you add your own tokens, you " +
...
{
    if (sScript == POET_DIALOG_PAGE)
    {
        PoetDialog_Page();
    }
    else if (sScript == POET_DIALOG_QUIT)
    {
        PoetDialog_Quit();
    }
    else if (sScript == POET_DIALOG_INIT)
    {
        PoetDialog_Init();
    }
    else if (sScript == ANVIL_DIALOG)
    {
        AnvilDialog();
    }
    else if (sScript == TOKEN_DIALOG)
    {
        TokenDialog();
    }
}
